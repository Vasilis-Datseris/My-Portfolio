...
let interval = 0;
let isPlayingFractals = false, isRainbow = true, isMoving = false;
let r = 0, g = 0, b = 255;
...
function init() {
    ...
    let g = document.getElementById("canvas"), f = initGL(), j, p, listener, q, m, r, n, x = Fractal.center[0], y = Fractal.center[1], xBase, yBase;
    ...
    (function e() {
        ...
        //}
        if (isMoving) {
            if (Fractal.center[0] != Fractal.center[0] + (x / (100 * Fractal.zoom * Fractal.zoom)))
                Fractal.center[0] = Fractal.center[0] + (x / (100 * Fractal.zoom * Fractal.zoom));
            if (Fractal.center[1] != Fractal.center[1] + (y / (100 * Fractal.zoom * Fractal.zoom)))
                Fractal.center[1] = Fractal.center[1] + (y / (100 * Fractal.zoom * Fractal.zoom));
        }
        if (isPlayingFractals)
            b();
    }
